...
{ config, pkgs, lib, options, ... }:{
  ...
  nix.binaryCaches = nix.binaryCaches ++ [ "https://hie-nix.cachix.org" # haskell-ide-engine cache
     ];
  nix.binaryCachePublicKeys = nix.binaryCachePublicKeys ++ [ "hie-nix.cachix.org-1:EjBSHzF6VmDnzqlldGXbi0RM3HdjfTU3yDRi9Pd0jTY=" # haskell-ide-engine cache key
     ];
